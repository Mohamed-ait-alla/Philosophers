...
/*   Updated: 2025/05/22 15:14:07 by mait-all         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_data(t_shared_data *philos_data, char **av)
{
	...
	if (av[5])
		philos_data->num_of_times_each_philosopher_must_eat = ft_atoi(av[5]);
	else
		philos_data->num_of_times_each_philosopher_must_eat = -1;
	...
	while (i < philos_data->nb_philos)
	{
		...
		philos_data->philos[i].last_meal_time = 0;
